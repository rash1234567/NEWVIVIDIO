...
function CarouselCard({title, overview, poster_path, backdrop_path}) {
  ...
  return (
    <div className='carousel w-[90%] h-[50vh] p-12 flex justify-around mt-2 rounded-[30px]' style={{backgroundImage: `url(${API_IMG+backdrop_path})`}}>
        <div className='carouselItem flex justify-around w-full h-full'>
          ...
          <div className='text-white ml-8 w-96 flex flex-col'>
              ...
              <div className='flex justify-between'>
                <button className='bg-[#ccccccaa] p-2 w-[45%] self-center rounded-2xl'>Trailer</button>
