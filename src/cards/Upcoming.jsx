...
function Upcoming({title,overview,poster_path,id}) {
  const {showDetails} = useUserAuth();

  return (
    <div className=" w-[100%] md:w-[60%] lg:w-full mx-auto bg-[#171029] rounded-lg shadow-md relative mt-3 cursor-pointer" onClick={()=>showDetails(id)} >
